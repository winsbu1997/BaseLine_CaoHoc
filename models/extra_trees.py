...
def train_extra_trees(X_train, y_train, X_val, y_val, X_test, y_test, save_data):
    ...
    print("Extra_trees Validation - Accuracy:", val_acc, "Precision:", val_pre, "Recall:", val_rec, "F1 Score:", val_f1)
    ...
    print("Extra_trees Test - Accuracy:", test_acc, "Precision:", test_pre, "Recall:", test_rec, "F1 Score:", test_f1)
