...
def train_bagging(X_train, y_train, X_val, y_val, X_test, y_test, save_data):
    ...
    print("Bagging Validation - Accuracy:", val_acc, "Precision:", val_pre, "Recall:", val_rec, "F1 Score:", val_f1)
    ...
    print("Bagging Test - Accuracy:", test_acc, "Precision:", test_pre, "Recall:", test_rec, "F1 Score:", test_f1)
